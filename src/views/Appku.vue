...
<template>
  <div class="container mx-auto">
    ...
    <div class="px-10 md:px-5">
      <ul
        class="w-full lg:w-1/2 mt-4 flex-row mx-auto items-center text-sm font-medium text-gray-900 bg-lime-200 border border-slate-300 rounded-lg">
